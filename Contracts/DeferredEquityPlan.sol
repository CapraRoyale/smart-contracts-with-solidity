...
contract DeferredEquityPlan {
    ...
    uint256 start_time = now; // permanently store the time this contract was initialized

    // @TODO: Set the `unlock_time` to be 365 days from now
    // Your code here!

    uint256 public distributed_shares; // starts at 0
    ...
    function distribute() public {
        require(
            msg.sender == human_resources || msg.sender == employee,
    ...
    function deactivate() public {
        require(
            msg.sender == human_resources || msg.sender == employee,
            "You are not authorized to deactivate this contract."
        );
        active = false;
    }
